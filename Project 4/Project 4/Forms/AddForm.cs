    ...
    public partial class AddForm : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((StudentType)cbxType.SelectedIndex == StudentType.Commuter)
                {
                    Program.StudentList.Add(new Student(newId, txbName.Text));
                }
                else
                {
                    Program.StudentList.Add(new DormStudent(newId, txbName.Text, (DormLocation)cbxDorm.SelectedItem, (MealPlan)cbxMeal.SelectedItem));
                }
