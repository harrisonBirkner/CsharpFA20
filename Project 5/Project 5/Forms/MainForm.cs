...
namespace Project_5
{
    public partial class MainForm : Form
    {
        ...
        private void btnAssignment_Click(object sender, EventArgs e)
        {
            if (cbxSelectedId.SelectedItem != null)
            {
                AssignmentsForm assignmentsForm = new AssignmentsForm();
                assignmentsForm.SelectedIndex = cbxSelectedId.SelectedIndex;
                assignmentsForm.ShowDialog();
            }
            else
            {
                MessageBox.Show("No student was selected for assignments", caption: "Error");
            }
        }
    }
}
